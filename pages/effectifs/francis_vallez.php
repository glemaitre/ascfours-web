			...
			<tr>
				...
				<div>
					...
					<!-- Photo -->
						<td >
							<br>
							&nbsp;&nbsp;&nbsp;<img src="../../images/effectifs/francis_vallez.jpg" />&nbsp;&nbsp;&nbsp;
						</td>
					...
					<!-- Informations -->
						...
						<td valign="top">
							<br><hr><br>9 Janvier 1954
							<br><br><hr><?php $years = (date('Y') - 1954);
									if(date('m') > 01)
									{
										$years = $years;
									}
									elseif((date('m') == 01)&&(date('j') >= 09))
									{
										$years = $years;
									}
									else
					...
					<!-- Table for results -->
						...
						<tr> <td valign="center" align="center">13 mars 2011</td> <td valign="center" align="center">Prix des Etangs de Montambert</td> <td valign="center" align="center">7<sup>ème</sup></td></tr>
