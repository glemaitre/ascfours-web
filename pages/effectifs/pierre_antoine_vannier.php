			...
			<tr>
				...
				<div>
					...
					<!-- Photo -->
						<td >
							<br>
							&nbsp;&nbsp;&nbsp;<img src="../../images/effectifs/pierre_antoine_vannier.jpg" />&nbsp;&nbsp;&nbsp;
						</td>
					...
					<!-- Informations -->
						...
						<td valign="top">
							<br><hr><br>18 Novembre 2000
							<br><br><hr><?php $years = (date('Y') - 2000);
									if(date('m') > 11)
									{
										$years = $years;
									}
					...
					<!-- Table for results -->
						...
						<tr> <td valign="center" align="center">13 mars 2011</td> <td valign="center" align="center">Prix des Etangs de Montambert</td> <td valign="center" align="center">1<sup>er</sup></td></tr>
