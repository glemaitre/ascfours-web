			...
			<tr>
				...
				<div>
					...
					<!-- Photo -->
						<td >
							<br>
							&nbsp;&nbsp;&nbsp;<img src="../../images/effectifs/christophe_trechot.jpeg" />&nbsp;&nbsp;&nbsp;
						</td>
					...
					<!-- Informations -->
						...
						<td valign="top">
							<br><hr><br>3 Mars 1972
							<br><br><hr><?php $years = (date('Y') - 1972);
									if(date('m') > 03)
									{
										$years = $years;
									}
									elseif((date('m') == 03)&&(date('j') >= 3))
									{
										$years = $years;
									}
									else
					...
					<!-- Table for results -->
						...
						<tr> <td valign="center" align="center">26 mars 2011</td> <td valign="center" align="center">VTT - La Machine</td> <td valign="center" align="center">5<sup>ème</sup></td></tr>
						<tr> <td valign="center" align="center">20 mars 2011</td> <td valign="center" align="center">Prix des Halles - Decize</td> <td valign="center" align="center">14<sup>ème</sup></td></tr>
						<tr> <td valign="center" align="center">13 mars 2011</td> <td valign="center" align="center">Prix des Etangs de Montambert</td> <td valign="center" align="center">6<sup>ème</sup></td></tr>
