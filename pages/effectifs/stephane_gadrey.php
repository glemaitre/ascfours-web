			...
			<tr>
				...
				<div>
					...
					<!-- Photo -->
						<td >
							<br>
							&nbsp;&nbsp;&nbsp;<img src="../../images/effectifs/stephane_gadret.jpg" />&nbsp;&nbsp;&nbsp;
						</td>
					...
					<!-- Informations -->
						...
						<td valign="top">
							<br><hr><br>26 Mars 1984
							<br><br><hr><?php $years = (date('Y') - 1984);
									if(date('m') > 03)
									{
										$years = $years;
									}
									elseif((date('m') == 03)&&(date('j') >= 26))
									{
										$years = $years;
									}
									else
					...
					<tr>
						...
						<tr> <td valign="center" align="center">20 mars 2011</td> <td valign="center" align="center">Prix des Halles - Decize</td> <td valign="center" align="center">25<sup>ème</sup></td></tr>
						<tr> <td valign="center" align="center">13 mars 2011</td> <td valign="center" align="center">Prix des Etangs de Montambert</td> <td valign="center" align="center">12<sup>ème</sup></td></tr>
