			...
			<tr>
				...
				<div>
					...
					<!-- Informations -->
						...
						<td valign="top">
							<br><hr><br>03 Septembre 1967
							<br><br><hr><?php $years = (date('Y') - 1967);
									if(date('m') > 09)
									{
										$years = $years;
									}
									elseif((date('m') == 09)&&(date('j') >= 03))
									{
										$years = $years;
									}
									else
					...
					<!-- Table for results -->
						...
						<tr> <td valign="center" align="center">13 mars 2011</td> <td valign="center" align="center">Prix des Etangs de Montambert</td> <td valign="center" align="center">1<sup>ère</sup></td></tr>
