			...
			<tr>
				...
				<div>
					...
					<!-- Photo -->
						<td >
							<br>
							&nbsp;&nbsp;&nbsp;<img src="../../images/effectifs/bernard_martin.jpg" />&nbsp;&nbsp;&nbsp;
						</td>
					...
					<!-- Informations -->
						...
						<td valign="top">
							<br><hr><br>10 Fevrier 1946
							<br><br><hr><?php $years = (date('Y') - 1946);
									if(date('m') > 02)
									{
										$years = $years;
									}
									elseif((date('m') == 02)&&(date('j') >= 10))
									{
										$years = $years;
									}
									else
					...
					<!-- Table for results -->
						...
						<tr> <td valign="center" align="center">20 mars 2011</td> <td valign="center" align="center">Prix des Halles - Decize</td> <td valign="center" align="center">8<sup>ème</sup></td></tr>
