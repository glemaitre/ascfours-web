			...
			<tr>
				...
				<div>
					...
					<!-- Photo -->
						<td >
							<br>
							&nbsp;&nbsp;&nbsp;<img src="../../images/effectifs/laffaye_bernard.jpg" />&nbsp;&nbsp;&nbsp;
						</td>
					...
					<!-- Informations -->
						...
						<td valign="top">
							<br><hr><br>10 Avril 1950
							<br><br><hr><?php $years = (date('Y') - 1950);
									if(date('m') > 04)
									{
										$years = $years;
									}
									elseif((date('m') == 04)&&(date('j') >= 10))
									{
										$years = $years;
									}
									else
					...
					<!-- Table for results -->
						...
						<tr> <td valign="center" align="center">20 mars 2011</td> <td valign="center" align="center">Prix des Halles - Decize</td> <td valign="center" align="center">peloton</td></tr>
