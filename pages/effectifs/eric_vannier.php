			...
			<tr>
				...
				<div>
					...
					<!-- Photo -->
						<td >
							<br>
							&nbsp;&nbsp;&nbsp;<img src="../../images/effectifs/eric_vannier.jpg" />&nbsp;&nbsp;&nbsp;
						</td>
					...
					<!-- Informations -->
						...
						<td valign="top">
							<br><hr><br>15 Septembre 1970
							<br><br><hr><?php $years = (date('Y') - 1970);
									if(date('m') > 09)
									{
										$years = $years;
									}
									elseif((date('m') == 09)&&(date('j') >= 15))
									{
										$years = $years;
									}
									else
									...
									echo $years ?> ans
							<br><br><hr>Rouleur - Puncheur - Sprinteur
							<br><br><hr>
						</td>
					</tr>
					...
					<!-- Table for results -->
						...
						<tr> <td valign="center" align="center">27 mars 2011</td> <td valign="center" align="center">Prix de Jully Lès Buxy</td> <td valign="center" align="center">nd<sup>ème</sup></td></tr>
						<tr> <td valign="center" align="center">20 mars 2011</td> <td valign="center" align="center">Prix des Halles - Decize</td> <td valign="center" align="center">20<sup>ème</sup></td></tr>
						<tr> <td valign="center" align="center">13 mars 2011</td> <td valign="center" align="center">Prix des Etangs de Montambert</td> <td valign="center" align="center">4<sup>ème</sup></td></tr>
						<tr> <td valign="center" align="center">6 mars 2011</td> <td valign="center" align="center">Challanges</td> <td valign="center" align="center">Peloton</sup></td></tr>
						<tr> <td valign="center" align="center">27 février 2011</td> <td valign="center" align="center">Izier</td> <td valign="center" align="center">Peloton</sup></td></tr>
