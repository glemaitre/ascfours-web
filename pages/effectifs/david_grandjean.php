			...
			<tr>
				...
				<div>
					...
					<!-- Photo -->
						<td >
							<br>
							&nbsp;&nbsp;&nbsp;<img src="../../images/effectifs/homme_inconnue.jpg" />&nbsp;&nbsp;&nbsp;
						</td>
					...
					<!-- Informations -->
						...
						<td valign="top">
							<br><hr><br>9 Mars 1970
							<br><br><hr><?php $years = (date('Y') - 1970);
									if(date('m') > 03)
									{
										$years = $years;
									}
									elseif((date('m') == 03)&&(date('j') >= 09))
									{
										$years = $years;
									}
									else
					...
					<!-- Table for results -->
						...
						<tr> <td valign="center" align="center">20 mars 2011</td> <td valign="center" align="center">Prix des Halles - Decize</td> <td valign="center" align="center">3<sup>ème</sup></td></tr>
						<tr> <td valign="center" align="center">13 mars 2011</td> <td valign="center" align="center">Prix des Etangs de Montambert</td> <td valign="center" align="center">Crevaison</td></tr>
