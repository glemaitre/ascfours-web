			...
			<tr>
				...
				<div>
					...
					<!-- Informations -->
						...
						<td valign="top">
							<br><hr><br>12 Aout 1943
							<br><br><hr><?php $years = (date('Y') - 1943);
									if(date('m') > 08)
									{
										$years = $years;
									}
									elseif((date('m') == 08)&&(date('j') >= 12))
									{
										$years = $years;
									}
									else
					...
					<!-- Table for results -->
						...
						<tr> <td valign="center" align="center">13 mars 2011</td> <td valign="center" align="center">Prix des Etangs de Montambert</td> <td valign="center" align="center">10<sup>ème</sup></td></tr>
