			...
			<tr>
				...
				<div>
					...
					<!-- Photo -->
						<td >
							<br>
							&nbsp;&nbsp;&nbsp;<img src="../../images/effectifs/lemaitre_cedric.jpg" />&nbsp;&nbsp;&nbsp;
						</td>
					...
					<!-- Informations -->
						...
						<td valign="top">
							<br><hr><br>8 Juillet 1982
							<br><br><hr><?php $years = (date('Y') - 1982);
									if(date('m') > 07)
									{
										$years = $years;
									}
									elseif((date('m') == 07)&&(date('j') >= 08))
									{
										$years = $years;
									}
									else
					...
					<!-- Table for results -->
						...
						<tr> <td valign="center" align="center">27 mars 2011</td> <td valign="center" align="center">Prix d'Orgeville</td> <td valign="center" align="center">peloton</td></tr>
						<tr> <td valign="center" align="center">20 mars 2011</td> <td valign="center" align="center">Prix d'Epernon</td> <td valign="center" align="center">35<sup>ème</sup></td></tr>
						<tr> <td valign="center" align="center">13 mars 2011</td> <td valign="center" align="center">Prix des Etangs de Montambert</td> <td valign="center" align="center">abandon</td></tr>
