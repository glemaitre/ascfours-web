			...
			<tr>
				...
				<div>
					...
					<!-- Photo -->
						<td >
							<br>
							&nbsp;&nbsp;&nbsp;<img src="../../images/effectifs/thierry_martin.jpg" />&nbsp;&nbsp;&nbsp;
						</td>
					...
					<!-- Informations -->
						...
						<td valign="top">
							<br><hr><br>16 Septembre 1980
							<br><br><hr><?php $years = (date('Y') - 1980);
									if(date('m') > 09)
									{
										$years = $years;
									}
									elseif((date('m') == 09)&&(date('j') >= 16))
									{
										$years = $years;
									}
									else
									...
									echo $years ?> ans
							<br><br><hr>Puncheur - Rouleur - Grimpeur - CLM - Cyclocross
							<br><br><hr>
						</td>
					</tr>
					...
					<!-- Table for results -->
						...
						<tr> <td valign="center" align="center">27 mars 2011</td> <td valign="center" align="center">Prix de Sennecey Le Grand</td> <td valign="center" align="center">6<sup>ème</sup></td></tr>
						<tr> <td valign="center" align="center">26 mars 2011</td> <td valign="center" align="center">VTT - La Machine</td> <td valign="center" align="center">3<sup>ème</sup></td></tr>
						<tr> <td valign="center" align="center">20 mars 2011</td> <td valign="center" align="center">Prix des Halles - Decize</td> <td valign="center" align="center">10<sup>ème</sup></td></tr>
						<tr> <td valign="center" align="center">13 mars 2011</td> <td valign="center" align="center">Prix des Etangs de Montambert</td> <td valign="center" align="center">8<sup>ème</sup></td></tr>
