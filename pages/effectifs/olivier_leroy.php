			...
			<tr>
				...
				<div>
					...
					<!-- Photo -->
						<td >
							<br>
							&nbsp;&nbsp;&nbsp;<img src="../../images/effectifs/olivier_leroy.jpeg" />&nbsp;&nbsp;&nbsp;
						</td>
					...
					<!-- Informations -->
						...
						<td valign="top">
							<br><hr><br>29 Septembre 1965
							<br><br><hr><?php $years = (date('Y') - 1965);
									if(date('m') > 09)
									{
										$years = $years;
									}
									elseif((date('m') == 09)&&(date('j') >= 29))
									{
										$years = $years;
									}
									else
					...
					<!-- Table for results -->
						...
						<tr> <td valign="center" align="center">27 mars 2011</td> <td valign="center" align="center">Prix D'Aix d'Angillon</td> <td valign="center" align="center">peloton</td></tr>
						<tr> <td valign="center" align="center">26 mars 2011</td> <td valign="center" align="center">VTT - La Machine</td> <td valign="center" align="center">nd</td></tr>
						<tr> <td valign="center" align="center">20 mars 2011</td> <td valign="center" align="center">Prix des Halles - Decize</td> <td valign="center" align="center">6<sup>ème</sup></td></tr>
						<tr> <td valign="center" align="center">13 mars 2011</td> <td valign="center" align="center">Prix des Etangs de Montambert</td> <td valign="center" align="center">2<sup>ème</sup></td></tr>
