			...
			<tr>
				...
				<div>
					...
					<!-- Photo -->
						<td >
							<br>
							&nbsp;&nbsp;&nbsp;<img src="../../images/effectifs/stephane_godest.jpg" />&nbsp;&nbsp;&nbsp;
						</td>
					...
					<!-- Informations -->
						...
						<td valign="top">
							<br><hr><br>17 Avril 1976
							<br><br><hr><?php $years = (date('Y') - 1976);
									if(date('m') > 04)
									{
										$years = $years;
									}
									elseif((date('m') == 04)&&(date('j') >= 17))
									{
										$years = $years;
									}
									else
									...
									echo $years ?> ans
							<br><br><hr>Grimpeur - VTT - Cyclocross
							<br><br><hr>
						</td>
					</tr>
